...
function Learn() {
    return (<>
    <Container class="learn">
    <img src={coding} class="learn"/>
...
<Row class="d-flex  align-items-center " className="g-4">
    <Col >
<img src={project} width={300}class="learn"/>
...
<Col>
    <img src={computer}height={300} width={300} class="learn"/>
    ...
    <Col>
    <img src={communities}height={300} width={300} class="learn"/>
    ...
    <Col>
    <img src={read}height={300}width={300} class="learn"/>
    ...
    <Row class="d-flex  align-items-center text-center " className="g-4">
        <Col>
    <img src={youtube}height={300} width={300} class="learn"/>
...
<Col>
    <img src={bootcamp}height={300} width={300}class="learn"/>
